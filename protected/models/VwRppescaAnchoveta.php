...
class VwRppescaAnchoveta extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'sd2' => 'Consumo D2 (Gl)',
			'sct' => 'Consumo D2 (Gl/Tn)',
			'sfd' => 'Facctor de descarga',
			'nomespecie' => 'Especie',
			'bodega' => 'Bodega disponible',
			'eficienciabodega' => 'Eficiencia de bodega',
			'horas' => 'Horas',
			'd2porhora' => 'Consumo D2 (Gl/h)',
			'horasta' => 'Horas totales',
		);
	}
