...
class Partes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('numerodecalas','numerical','integeronly'=>true, 'min'=>1 , 'max'=> 9, 'message'=>'Hermano, tu me quieres sorprender mas de 9 calas es imposible en 24 horas que han pasado'),
