...
/**
 * This is the model class for table "{{tempdfactur}}".
 *
 * The followings are the available columns in table '{{tempdfactur}}':
 * @property string $id
 ...
 */
class Tempdfactur extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Tempdfactur the static model class
	 */
