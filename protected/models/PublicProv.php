 ...
 */
class PublicProv extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PublicProv the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('codprov, provincia', 'required'),
			array('codprov', 'length', 'max'=>2),
			array('provincia', 'length', 'max'=>40),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, codprov, provincia', 'safe', 'on'=>'search'),
		);
	}
