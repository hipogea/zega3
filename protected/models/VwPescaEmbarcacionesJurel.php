...
/**
 * This is the model class for table "vw_pesca_embarcaciones_jurel".
 *
 * The followings are the available columns in table 'vw_pesca_embarcaciones_jurel':
 ...
 */
class VwPescaEmbarcacionesJurel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return VwPescaEmbarcacionesJurel the static model class
	 */
	...
	{
		return 'vw_pesca_embarcaciones_jurel';
	}
