...
/**
 * This is the model class for table "{{tipooc}}".
 *
 * The followings are the available columns in table '{{tipooc}}':
 * @property string $codtipo
 * @property string $destipo
 */
class Tipooc extends CActiveRecord
{
	/**
	 ...
	 * @return Tipooc the static model class
	 */
