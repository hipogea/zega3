...
class Temporadas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		//REGLAS PARA EL ESCENARIO DE CREAR PARTE   "escenarioparte"
			...
			array('destemporada','required','message'=>'Llena la descripcion','on'=>'insert,update'),
			array('inicio','required','message'=>'Llena la fecha de inicio','on'=>'insert,update'),
			array('zonalitoral','required','message'=>'Llena la zona : CEN-->CENTRO NORTE      SUR --> SUR','on'=>'insert,update'),
			array('termino','required','message'=>'Llena la fecha de fin','on'=>'insert,update'),
			...
			array('cuota_anchoveta','required','message'=>'Indica la cuota asignada a la empresa','on'=>'insert,update'),
			array('cuota_global_anchoveta','required','message'=>'Indica la cuota global','on'=>'insert,update'),			
				
				array('inicio','checkfecha','on'=>'insert,update'),
				array('termino','checkfecha','on'=>'insert,update'),
			
			//array('idespecie,fechadehoy,id,cuota_global_anchoveta, cuota_anchoveta,destemporada, inicio, termino', 'safe','on'=>'insert'),
			array('cuota_global_anchoveta, cuota_anchoveta,destemporada, inicio,zonalitoral, termino', 'safe','on'=>'insert,update'),
			array('id,cuota_global_anchoveta, cuota_anchoveta,destemporada, inicio,zonalitoral, termino', 'safe','on'=>'search'),
		);
	}
