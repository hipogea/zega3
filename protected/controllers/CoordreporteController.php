...
class CoordreporteController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Coordreporte');
	...
	{
		$model=new Coordreporte('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Coordreporte']))
			$model->attributes=$_GET['Coordreporte'];
	 ...
	 * @param Coordreporte $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='coordreporte-form')
		{
