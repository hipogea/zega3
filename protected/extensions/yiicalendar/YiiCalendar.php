...
class YiiCalendar extends CWidget {
  ...
  public function run() {
     // die();
      //var_dump($this->getDataProvider()->getPagination()->getPageSize());die();
  ...
  private function resolveViewFile($customView, $defaultView) {
      ...
      var_dump( $this->getOwner()->getViewFile('/'.$customView));
      var_dump($this->getViewFile($defaultView));
      var_dump("resultado");
      var_dump($customView ? $this->getOwner()->getViewFile($customView) : $this->getViewFile($defaultView));
    die();*/
      //var_dump($customView ? $customView : $this->getViewFile($defaultView));die();
      return $customView ? $customView : $this->getViewFile($defaultView);
  }
