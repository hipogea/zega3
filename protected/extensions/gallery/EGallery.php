	...
	public function run()
	{
		...
		else
		{
			...
			$this->_images = parent::splitImages($this->_images,$pages->pageSize);
                ...
                echo "this->id     ";var_dump($this->id);echo "<br>";
                 echo "this->name     ";var_dump($this->name);echo "<br>";
                  echo "this->shownav     ";var_dump($this->showNav);echo "<br>";
                  echo "pages     ";var_dump($pages);echo "<br>";
                  echo "this->display numimages     ";var_dump($this->displayNumImages);echo "<br>";
                  echo "this->imagesPerRow     ";var_dump($this->imagesPerRow);echo "<br>";
                  echo "this->albumsPerRow     ";var_dump($this->albumsPerRow);echo "<br>";
                  echo "this->parent::getDetails(this->_dir)     ";var_dump(parent::getDetails($this->_dir));echo "<br>";
                  echo "this->display numimages     ";var_dump($this->displayNumImages);echo "<br>";
                  echo "this->_albums     ";var_dump($this->_albums);echo "<br>";
                  echo "this->_images     ";var_dump($this->_images);echo "<br>";
                 die();
