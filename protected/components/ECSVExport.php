...
class ECSVExport extends CApplicationComponent
{
    /**
   ...
   /* public function __construct($dataProvider, $exportFull=true, $includeColumnHeaders=true, $delimiter=null, $enclosure=null) 
    ...
    public function initParams($dataProvider, $exportFull=true, $includeColumnHeaders=true, $delimiter=null, $enclosure=null){
        $this->_dataProvider = $dataProvider;
        $this->exportFull = (bool) $exportFull;
        $this->includeColumnHeaders = (bool) $includeColumnHeaders;
        if($delimiter) $this->_delimiter = $delimiter;
    ...
    public function setDataProvider($dataprovider,$force=false){
        if(is_null($this->_dataProvider) or $force)
                $this->_dataProvider=$dataprovider;
      }
