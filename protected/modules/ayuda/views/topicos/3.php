...
<p>Al iniciar la aplicación aparece la pantalla de acreditación, donde se debe de indicar el
    nombre de usuario y la contraseña. Adicionalmente debe de consultar con el administrador del
    sistema las diversas opciones que el sistema ofrece para el registro de usuarios.Una vez efectuado el
    login de usuario tenemos la patanalla de bienvenida, la cual podemos observar las erspectiuvas divisiones
    funcionales : <br><br>
