...
public function actionprueba(){
  ...
  yii::app()->maletin->insertafila(3,'Clipro', null);
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('suggestotsimple','suggestcompo','suggestNe',  'suggestot','suggestceco','llenahijos','fillLocations',   'llenaCertificados', 'prueba',  'otroMaestrocompo','suggestMaterial',
