...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('hidmot')); ?>:</b>
	<?php echo CHtml::encode($data->hidmot); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('codigoequipo')); ?>:</b>
	<?php echo CHtml::encode($data->codigoequipo); ?>
	<br />
