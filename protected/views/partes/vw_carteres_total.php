...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'cssFile' => ''.Yii::app()->getTheme()->baseUrl.Yii::app()->params['rutatemagrid'].'style_gridpartes.css', 
	'columns'=>array(
		...
		array('name'=>'porcentaje','header'=>'porcentaje','value'=>'$data->porcentaje."%"'),
		//'fulectura',
		array('name'=>'fulectura','header'=>'Fu lectura','value'=>'date("d/m/Y",strtotime($data->fulectura))'),
		array('name'=>'horasfaltantes','header'=>'Faltan (Hr)','value'=>'$data->horasfaltantes'),
		array('name'=>'diasfaltantes','header'=>'Faltan (dias)','value'=>'$data->diasfaltantes'),
		array('name'=>'pp','header'=>'Faltan (dias)','value'=>'$data->pp'),
