...
<div class='crugepanel user-assignments-role-list'>
	<h1><?php echo "Roles Disponibles";?></h1>
	<p><?php echo "Haz click en un rol para ver los usuarios asignados a el";?></p>
	<ul class='auth-item'>
	<?php 
		$loader = "<span class='loader'></span>";
		
		//foreach($rbac->roles as $rol){
			echo "<li alt='hoja'>uno".$loader."</li>";
			echo "<li alt='hoja'>dos".$loader."</li>";
			echo "<li alt='hoja'>uno".$loader."</li>";
			echo "<li alt='hoja'>dos".$loader."</li>";
...
<div class='crugepanel user-assignments-detail'>
	...
	<div id='revocarSeleccion' class='boton'>
		<?php echo "revocar seleccion"; ?>
	</div>
	<?php 
		$this->widget(Yii::app()->user->ui->CGridViewClass, array(
			'id'=>'_lista1',
			'selectableRows'=>2,
			'dataProvider'=>Embarcaciones::model()->search(),
			'columns'=>array(
				array(
	...
	<div id='asignarSeleccion' class='boton'>
		<?php echo "asignar seleccion";?></div>
	<?php 
		$this->widget(Yii::app()->user->ui->CGridViewClass, array(
			'id'=>'_lista2',
			'selectableRows'=>2,
			'dataProvider'=>CrugeGruposMail::model()->search(),
			'columns'=>array(
				array(
					'class'=>'CCheckBoxColumn'
				),
