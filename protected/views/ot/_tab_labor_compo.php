...
<div class="row">
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'numeroingreso'); ?>
          <?php
		  $ruta=$this->createUrl('Request/suggestNe');      
           $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
			'model'=>$model,
			'attribute'=>'numeroingreso',
                        'source'=>$ruta,
                        'options'=>array(
				'showAnim'=>'fold',),
            ...
            ?>
	<?php echo $form->error($model,'numeroingreso'); ?>
	</div>      
    
      <div class="row">
	<?php echo $form->labelEx($model,'canticomp'); ?>
        <?php echo $form->textField($model,'canticomp',array('')); ?>
	<?php echo $form->error($model,'canticomp'); ?>
	</div>
	...
	<?php echo $form->labelEx($model,'textoactividad'); ?>
        <?php echo $form->textField($model,'textoactividad',array('')); ?>
