	...
	<div class="wide form">
		...
		<div class="panelizquierdo">
			...
			<div class="row">
				...
				<?php echo $form->hiddenField($model,'numvale',array('size'=>12,'maxlength'=>12 ,'disabled'=>'disabled')); ?>
			</div>
			<div class="row">
				...
				<?php  } else {
					echo $form->textfield($model,'fechavale',array('disabled'=>''));
				}
				?>
			</div>
		...
		<div class="panelderecho">
			...
			<div class="row">
				<?php //echo CHtml::label('Centroemisor','Centroemisor'); ?>
				<?php
				if($model->isNewRecord) {
					$datos1 = CHtml::listData(Centros::model()->findAll(array('order'=>'nomcen')),'codcen','nomcen');
			...
			<div class="row">
				<?php //echo CHtml::label('AlmacenEmisor','AlamcenEmisor'); ?>
				<?php echo $form->textField($model,'codaldestino',array('size'=>4));?>
