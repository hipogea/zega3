...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <fieldset>
      <legend> Datos automaticos </legend>
	  
	<?php //echo $form->errorSummary($model); ?>
    <div class="row">
		<?php echo $form->labelEx($model,'codigocreado'); ?>
		<?php echo $form->textField($model,'codigocreado',array('size'=>12,'maxlength'=>12,'Disabled'=>'Disabled',)); ?>
		<?php echo $form->error($model,'codigocreado'); ?>
	</div>
	
	<div class="row">
		<?php echo $form->labelEx($model,'descripcionfinal'); ?>
		<?php echo $form->textField($model,'descripcionfinal',array('size'=>40,'maxlength'=>40,'Disabled'=>'Disabled',)); ?>
		<?php echo $form->error($model,'descripcionfinal'); ?>
	</div>
  ...
  <fieldset>
	...
	<div class="row">
		...
		<?php echo $form->labelEx($model,'codigoestado'); 
	echo $form->DropDownList($model,
							'codigoestado',
							CHtml::listData(
												Estado::model()->findAll(" codocu='042'",array()),
												"codestado",
											"estado"
											),
							array("empty"=>"--",
