...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('textocabecera')); ?>:</b>
	<?php echo CHtml::encode($data->textocabecera); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('fechanec')); ?>:</b>
	<?php echo CHtml::encode($data->fechanec); ?>
	<br />
